...
\begin{figure}[!htp]
    \centering
    \resizebox{6cm}{!}{\input{example/figure/example/flow_chart.tex}}
...
\begin{table}[!hpb]
  ...
  \end{tabular}
\end{table}
\footnotetext[1]{这个例子来自\href{http://www.ctan.org/tex-archive/macros/laexample/tex/contrib/booktabs/booktabs.pdf}{《Publication quality tables in LATEX》}(booktabs宏包的文档)。这也是一个在表格中使用脚注的例子，请留意与threeparttable实现的效果有何不同。}
...
\href{http://mirror.ctan.org/macros/laexample/tex/contrib/listings/listings.pdf}{listings宏包手册}。
...
algorithmicx的详细使用方法见\href{http://mirror.hust.edu.cn/CTAN/macros/laexample/tex/contrib/algorithmicx/algorithmicx.pdf}{官方README}。
